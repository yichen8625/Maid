...
WebUI.click(findTestObject('Object Repository/Home/申請類型/List/input_申請撤下抗封鎖目標'))

WebUI.click(findTestObject('Object Repository/Home/btn_search'))

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('Object Repository/Home/td_申請類型'), '申請撤下抗封鎖目標')
