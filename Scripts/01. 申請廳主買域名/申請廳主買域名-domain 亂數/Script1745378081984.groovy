...
// 發送申請廳主買域名請求
def response = WS.sendRequest(findTestObject('Object Repository/API/申請廳主買域名/中長期/申請廳主買域名'))
...
// 發送取得自動化申請詳細資料請求
response = WS.sendRequest(findTestObject('Object Repository/API/申請廳主買域名/中長期/取得自動化申請詳細資料'))
...
// 發送取得自動化工作項目資料請求
response = WS.sendRequest(findTestObject('Object Repository/API/申請廳主買域名/中長期/取得自動化工作項目資料'))
WS.verifyResponseStatusCode(response, 200) // 檢查 HTTP 狀態碼是否為 200
...
WebUI.navigateToUrl(GlobalVariable.G_VIR_URL+"/#/auto_detail/"+GlobalVariable.WORKFLOW_ID)
